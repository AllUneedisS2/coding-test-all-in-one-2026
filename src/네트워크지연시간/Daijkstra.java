...
// 내가봤을땐... "priority우선탐색"이라고 명명해도 될듯?..
// 그럼.. BFS도아니고.. DFS도아니고.. PFS..? 앜ㅋㅋㅋ
public class Daijkstra {
    ...
    public static void main(String args[]) {
        ...
        int n1 = 4;
        int k1 = 2;
        System.out.println(daijkstra(times1, n1, k1));
        ...
        int n2 = 4;
        int k2 = 4;
        System.out.println(daijkstra(times2, n2, k2));
        ...
        int n3 = 4;
        int k3 = 1;
        System.out.println(daijkstra(times3, n3, k3));

        // 예시 4 (노간선, 한 노드) — 기대: 0
        int[][] times4 = new int[][] { };
        int n4 = 1;
        int k4 = 1;
        System.out.println(daijkstra(times4, n4, k4));
        ...
        int n5 = 4;
        int k5 = 1;
        System.out.println(daijkstra(times5, n5, k5));
        ...
        int n6 = 3;
        int k6 = 1;
        System.out.println(daijkstra(times6, n6, k6));
        ...
        int n7 = 3;
        int k7 = 1;
        System.out.println(daijkstra(times7, n7, k7));
        ...
        int n8 = 5;
        int k8 = 1;
        System.out.println(daijkstra(times8, n8, k8));
        ...
        int n9 = 3;
        int k9 = 1;
        System.out.println(daijkstra(times9, n9, k9));

        // 예시 10 (노들이 있지만 시작 노드 고립) — 기대: -1
        int[][] times10 = new int[][] { };
        int n10 = 3;
        int k10 = 2;
        System.out.println(daijkstra(times10, n10, k10));

    }

    static int daijkstra(int[][] times, int n, int k) {
